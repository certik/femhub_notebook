...
The :class:`NotebookObject` is used to configure and launch a FEMhub
Notebook server.
"""
#############################################################################
...
class NotebookObject:
    ...
    INPUT:
        ...
        - ``directory`` -- string; directory that contains the FEMhub
        ...
        - ``timeout`` -- integer (default: 0) seconds until idle
          ...
          corresponding FEMhub session terminates. 0 means "never
